...
> Auto-generated by `src/stage_07f_journey_report.py`. Re-run the script any time results change; this file is overwritten in full each run. Template: `docs/RESEARCH_JOURNEY_REPORT.md`.
