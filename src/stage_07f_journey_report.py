...
and renders docs/RESEARCH_JOURNEY_REPORT_FILLED.md -- a fully-filled version of
the docs/RESEARCH_JOURNEY_REPORT.md skeleton, with real numbers, tables, and
embedded figure links. The skeleton itself is never modified; this script is
...
def run(cfg: dict, repo_root: str) -> None:
    ...
    a(f"> Auto-generated by `src/stage_07f_journey_report.py`. Re-run the script any time "
      ...
      f"`docs/RESEARCH_JOURNEY_REPORT.md`.\n")
    a("---\n")
    ...
    for f, desc in [
        ...
        ("docs/VISUALIZATION_FIGURES_PLAN.md", "Rencana figure paper, Bagian 1-4"),
    ...
    out_path = os.path.join("docs", "RESEARCH_JOURNEY_REPORT_FILLED.md")
