...
\title{Lung Nodule Fusion + XAI \\ (judul sementara --- ganti)
...
% ---------------------------------------------------------------------------
% BIBLIOGRAPHY: di bawah ini daftar contoh bawaan template (b1..b11) supaya
% langsung ter-compile. Untuk paper sungguhan, pakai Zotero + refs.bib:
%   1) hapus/komentari blok \begin{thebibliography}...\end{thebibliography} ini
%   2) uncomment 2 baris berikut:
%        \bibliographystyle{IEEEtran}
%        \bibliography{refs}
% refs.bib dikelola Zotero (Better BibTeX auto-export) --- JANGAN edit tangan.
% ---------------------------------------------------------------------------
